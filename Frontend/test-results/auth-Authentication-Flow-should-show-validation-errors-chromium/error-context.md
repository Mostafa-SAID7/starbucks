...
- Name: auth.spec.ts >> Authentication Flow >> should show validation errors
      ...
      - generic [ref=e9]:
        ...
        - generic [ref=e26]:
          ...
          - button "الوضع الداكن" [ref=e41]:
            - img [ref=e43]
          - button "تسجيل الدخول / الانضمام للمكافآت" [active] [ref=e46]:
            - img [ref=e47]
          ...
          - generic [ref=e66]:
            - tabpanel [ref=e67]:
              - generic [ref=e68]:
                ...
                - textbox "البريد الإلكتروني" [ref=e70]
              - generic [ref=e71]:
                - generic [ref=e72]: كلمة المرور
                - textbox "كلمة المرور" [ref=e73]
              - generic [ref=e74]:
                - generic [ref=e75]:
