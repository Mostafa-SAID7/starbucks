  ...
  const socialIcons: Record<string, React.ReactNode> = {
    spotify: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
        <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.503 17.306c-.215.352-.676.463-1.028.248-2.856-1.745-6.452-2.14-10.686-1.171-.403.093-.812-.154-.905-.557-.093-.404.154-.813.557-.906 4.636-1.059 8.618-.604 11.804 1.341.352.215.463.676.248 1.028zm1.468-3.26c-.27.439-.844.582-1.282.311-3.268-2.009-8.25-2.593-12.115-1.42-.496.151-1.022-.128-1.173-.625-.152-.496.128-1.022.625-1.173 4.417-1.341 9.908-.68 13.645 1.62.439.27.581.844.311 1.282zm.127-3.418c-3.918-2.327-10.375-2.541-14.135-1.399-.6.182-1.235-.164-1.417-.765-.183-.601.164-1.236.765-1.418 4.305-1.306 11.438-1.051 15.945 1.625.539.32.714 1.014.394 1.554-.32.539-1.014.713-1.554.394z"/>
      </svg>
    ),
    facebook: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
    ...
    tiktok: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
        <path d="M12.525.02c1.31 0 2.59.34 3.72 1a6.49 6.49 0 0 1 3.57 5.1c0 .02 0 .04 0 .06a6.49 6.49 0 0 0-3.15-1.55v7.2a4.91 4.91 0 0 1-4.91 4.91 4.91 4.91 0 0 1-4.91-4.91 4.91 4.91 0 0 1 4.91-4.91c.21 0 .41.01.62.04v2.54a2.41 2.41 0 0 0-.62-.08 2.37 2.37 0 1 0 2.37 2.37v-12c0-.02 0-.04 0-.06.01-1.07.72-2.01 1.75-2.28a2.38 2.38 0 0 1 1.65.57 6.49 6.49 0 0 0 3.15 1.55c.01-.2.02-.41.02-.62 0-1.33-.42-2.61-1.2-3.69A6.49 6.49 0 0 0 16.245.02h-3.72z"/>
      </svg>
    )
  }
              ...
              <div className="flex flex-wrap gap-4">
                ...
                >
                  <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-.4-.18-.84-.28-1.29-.28s-.9.1-1.3.28c-1.01.47-2.02.51-2.95-.42C5.9 17.78 4.28 12.35 6.8 7.9c1.23-2.17 3.4-3.4 5.6-3.4 1.1 0 2.15.25 3 .75.65.35 1.25.35 1.9 0 .95-.5 2-.8 3.1-.75 1.55.05 2.85.7 3.65 1.85-3.35 1.95-2.8 6.35.55 7.8-.8 2-1.95 3.95-3.55 6.13zM12 4.45c0-2.3 1.9-4.2 4.2-4.2.1 0 .2 0 .3.05.1 2.3-1.8 4.2-4.2 4.2-.1 0-.2 0-.3-.05z"/>
                  </svg>
                ...
                >
                  <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 0 1-.41-.814V2.628c0-.34.17-.65.41-.814zm11.233 11.233l2.84 2.84L5.672 21.01l9.17-7.963zm2.84-2.84l-2.84 2.84-9.17-7.963 12.01 5.123zM14.842 12l-1.05-1.05 4.95-2.115 1.874 1.874a.996.996 0 0 1 0 1.414l-1.874 1.874-3.9-3z"/>
                  </svg>
                  <div className="text-start">
