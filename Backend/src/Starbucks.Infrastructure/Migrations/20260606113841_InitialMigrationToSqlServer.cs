...
namespace Starbucks.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title_English = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Title_Arabic = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Title_En = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Title_Ar = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Subtitle_English = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    Subtitle_Arabic = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    ...
                    ActionText_English = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    ActionText_Arabic = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    ActionText_En = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ActionText_Ar = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayName_English = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    DisplayName_Arabic = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ...
                    LocalizedAddress_English = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    LocalizedAddress_Arabic = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    LocalizedAddress_En = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LocalizedAddress_Ar = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    HasDriveThru = table.Column<bool>(type: "bit", nullable: false),
                    IsAccessible = table.Column<bool>(type: "bit", nullable: false),
                    HasOutdoorSeating = table.Column<bool>(type: "bit", nullable: false),
                    AcceptsMobileOrders = table.Column<bool>(type: "bit", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    SortOrder = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefreshTokenIssuedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title_En = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Title_Ar = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Message_English = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Message_Arabic = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Message_En = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Message_Ar = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastPointsActivity = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Caffeine = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedModifiersJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locations_City_Governorate",
                table: "Locations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_SubcategoryId_Slug",
                table: "MenuItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItemVariants_MenuItemId_IsAvailable_IsDeleted",
                table: "MenuItemVariants",
                columns: new[] { "MenuItemId", "IsAvailable", "IsDeleted" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuSubcategories_CategoryId_Slug",
                table: "MenuSubcategories",
